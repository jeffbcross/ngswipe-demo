describe("angular+jqlite", function() {
  ...
  describe("api/ngMobile.$swipe", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/ngMobile.$swipe");
    });
...
describe("angular+jquery", function() {
  ...
  describe("api/ngMobile.$swipe", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/ngMobile.$swipe");
    });
